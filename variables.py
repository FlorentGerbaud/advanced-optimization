...
# _______________________________________ For lagrangian method  _______________________________________#

beta = 0
alpha_1 = 20
alpha_2 = 0.01

# ______________________________________ Condition linear ___________________________________________________#


# a = -4.0
# b = 4.0
# Var_ini = a * np.linspace(0, 1, dim_opt)  + b  # Générer une fonction linéaire
